    ...
    macro_rules! update {
        ...
        ($table: ident, $type: ident, $update_type: ident) => {
            pub fn update(conn: &SqliteConnection, id: i32, update_data: $update_type) -> QueryResult<$type> {
                ...
                diesel::update(crate::schema::$table::table
                    .find(id))
                    .set(&update_data)
                    .execute(conn)?;
...
pub mod association {
    ...
    macro_rules! get_all_associations {
        ...
        (
            ...
            pub fn $function_name(resource: &$first_resource_type, conn: &SqliteConnection) -> QueryResult<Vec<$second_resource_type>> {
    ...
    macro_rules! create_association {
        ...
        (
            ...
            pub fn $function_name(first_resource: &$first_resource_type, second_resource: &$second_resource_type, conn: &SqliteConnection) -> QueryResult<$association_type> {
    ...
    macro_rules! delete_association {
        ...
        (
            ...
            pub fn $function_name(first_resource: &$first_resource_type, second_resource: &$second_resource_type, conn: &SqliteConnection) -> bool {

                diesel::delete(crate::schema::$association_table::table
