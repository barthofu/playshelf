...
pub enum Error {
    ...
    #[error("{}", Status::InternalServerError)] Internal,
    #[error("{}", Status::BadRequest)] BadRequest,
    #[error("{}", Status::Unauthorized)] Unauthorized,
    #[error("{}", Status::Forbidden)] Forbidden,
    #[error("{}", Status::NotFound)] NotFound,
    #[error("{}", Status::NotModified)] NotModified,
    ...
    #[error("This resource already exists")] AlreadyExists,
}
